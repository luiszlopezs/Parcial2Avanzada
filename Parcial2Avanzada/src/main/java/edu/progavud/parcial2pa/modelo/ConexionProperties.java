 ...
 * 
 * Atributos:
 * - {@code propiedades}: Objeto Properties que almacena las claves y valores de configuración.
...
public class ConexionProperties {
   ...
   /**
     ...
     * asociado al flujo {@code archivoIn} y los carga en el objeto {@code propiedades}.
     * 
 ...
 /**
     ...
     * 
     * @return Objeto {@code Properties} que contiene las configuraciones cargadas.
     */
   ...
   /**
     ...
     * 
     * @param propiedades Objeto {@code Properties} con las configuraciones a guardar.
     */
     ...
     * 
     * @return Objeto {@code FileInputStream} asociado al archivo .properties de entrada.
     */
 ...
 /**
     ...
     * 
     * @return Objeto {@code FileOutputStream} asociado al archivo .properties de salida.
     */
